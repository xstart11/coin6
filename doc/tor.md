TOR SUPPORT IN 1X2 Coin
=======================

It is possible to run 1X2 Coin as a Tor hidden service, and connect to such services.
...
Run 1X2 Coin behind a Tor proxy
----------------------------------

The first step is running 1X2 Coin behind a Tor proxy. This will already make all
...
List of known 1X2 Coin Tor relays
------------------------------------
```
